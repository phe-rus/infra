...
export const Route = createFileRoute("/_account/payments")({
    loader: async ({ context: { q } }) => {
        await Promise.all([q.ensureQueryData(myPaymentsOptions()), q.ensureQueryData(paymentConfigOptions())])
    },
    ...
    return (
        <article className="container mx-auto flex w-full flex-col gap-8 py-20 md:max-w-md">
            <section>
                ...
                <p className="text-muted-foreground">Fund your account and review your payment history.</p>
            </section>
