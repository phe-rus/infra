...
export function avatarKey(userId: string, ext: AllowedExtension): string {
...
export async function getUserUsageBytes(bucket: R2Bucket, userId: string): Promise<number> {
