...
export const DisableTwoFactor: FC<DisableTwoFactorProps> = ({
    viewUser,
}) => {
    ...
    return (
        <section className="flex flex-col gap-2">
            ...
            <p className="text-xs text-muted-foreground">
                This user has 2FA enabled. If they've lost
                access to their authenticator, disable it here
                so they can sign in and set it up again.
            </p>
            <Button
                type="button"
                variant="outline"
