...
export const user = sqliteTable("user", {
    ...
    updatedAt: integer("updatedAt", { mode: "timestamp_ms" })
        ...
        .notNull(),
    role: text("role"),
    banned: integer("banned", { mode: "boolean" }).default(
        false
    ),
...
export const passkey = sqliteTable(
    ...
    (table) => [
        ...
        index("passkey_credentialID_idx").on(
            table.credentialID
        ),
    ]
)
...
export const oauthClientResource = sqliteTable(
    ...
    (table) => [
        ...
        index("oauthClientResource_clientId_idx").on(
            table.clientId
        ),
        index("oauthClientResource_resourceId_idx").on(
            table.resourceId
        ),
    ]
)
...
export const oauthRefreshToken = sqliteTable(
    "oauthRefreshToken",
    {
        ...
        sessionId: text("sessionId").references(
            () => session.id,
            {
                onDelete: "set null",
            }
    ...
    (table) => [
        index("oauthRefreshToken_clientId_idx").on(
            table.clientId
        ),
        index("oauthRefreshToken_sessionId_idx").on(
            table.sessionId
        ),
        index("oauthRefreshToken_userId_idx").on(
            table.userId
        ),
...
export const oauthAccessToken = sqliteTable(
    "oauthAccessToken",
    {
        ...
        refreshId: text("refreshId").references(
    ...
    (table) => [
        index("oauthAccessToken_clientId_idx").on(
            table.clientId
        ),
        index("oauthAccessToken_sessionId_idx").on(
            table.sessionId
        ),
        ...
        index("oauthAccessToken_refreshId_idx").on(
            table.refreshId
        ),
    ]
)
