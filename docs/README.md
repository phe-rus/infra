...
Continue to **[Getting Started](getting-started.md)** to deploy your own instance, or jump to a specific piece:

- [Architecture](architecture.md) — what's actually running, and where your data lives
- [OAuth Provider](oauth-provider.md) — registering applications and signing users in via OAuth 2.1 / OIDC
