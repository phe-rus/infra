...
export const resources: Resource[] = [
    ...
    },
    {
        ...
        body: [
            {
                p: "Pride, also known as Pherus Pride, is a community-driven platform designed to help LGBTQIA+ people discover trusted resources, opportunities, and support through verified community knowledge.",
            },
            {
                p: "The idea was born from personal experience. While navigating my own transition in Uganda, I found it difficult to locate reliable information about healthcare providers, safe spaces, legal support, employment opportunities, and other resources relevant to queer people. Much of this information existed only through word of mouth, private conversations, google search, redditing, and small community networks.",
            },
            {
                p: "Pride aims to make that knowledge more accessible while protecting community members. The platform allows people to share trusted information with one another, helping others find resources that may otherwise be difficult to discover.",
            },
            { h2: "Q2Q" },
            {
                p: "The project is built around a concept I call Q2Q (Queer-to-Queer), where community members help one another through shared knowledge, opportunities, and support.",
            },
            { h2: "Through Pride, users can" },
            {
                ul: [
                    "Discover trusted healthcare and transition resources: find information about healthcare providers, gender-affirming care, surgeries, hormones, mental health support, HIV services, and other health-related resources recommended by the community.",
                    "Find LGBTQ+ friendly services and safe spaces: locate trusted businesses, organizations, community centers, housing options, and safe environments where queer people can feel welcome and supported.",
                    "Access jobs, careers, and professional opportunities: discover job openings, freelance work, mentorship opportunities, professional networks, and career development resources shared by community members and allies.",
                    "Learn practical and professional skills: access community-driven learning resources covering software development, design, construction, electrical work, plumbing, entrepreneurship, cooking, personal finance, and everyday life skills.",
                    "Connect with legal, educational, and community support: find lawyers, advocacy organizations, educational opportunities, scholarships, immigration guidance, housing assistance, and other resources relevant to LGBTQ+ individuals.",
                    "Participate in mutual aid and community support: support and receive help through community initiatives, crowdfunding, volunteering, housing assistance, medical support, mentorship, and peer-to-peer aid programs.",
                    "Support creators, businesses, and startups: follow creators, discover queer-owned businesses, support startups, promote services, and help strengthen the economic growth of the community.",
                    "Access trusted educational resources: explore information about transition, health, wellness, HIV, relationships, personal development, technology, finance, and countless other topics contributed and reviewed by the community.",
                    "Benefit from real-world community knowledge: access practical information from people who have firsthand experience, whether looking for surgery options, housing, legal assistance, immigration guidance, education, employment, or relocation support.",
                    "Discover opportunities across borders: Pride is built to be both local and global, so community members can share knowledge about healthcare, legal systems, education, employment, and relocation pathways across different countries.",
                ],
            },
            { h2: "Local, and global" },
            {
                p: "Pride is intended to be both local and global. A person in Uganda, Kenya, Germany, Brazil, or any other country can contribute information that may help someone else in their community while benefiting from knowledge shared by others around the world.",
            },
            {
                p: "The long-term goal is to create a trusted ecosystem where queer people can help queer people navigate life more safely, efficiently, and confidently.",
            },
            { h2: "Where it actually stands" },
            {
                ul: [
                    "Stage 1, Foundation (2025 – early 2026): done. Platform infrastructure and architecture; authentication via Pass passkeys and OAuth; design system and shared component library; public web presence (home, about, roadmap); multilingual support in English, French, and Chinese.",
                    "Stage 2, Content Architecture (2026): in progress. The public roadmap page is done; resource taxonomy and community guidelines are in progress; data models for resource submissions and the legal/privacy framework are still planned.",
                    "Stage 3, Platform MVP (2026): planned. User registration and community profiles, resource submission, the healthcare/safe-spaces/legal directories, search and discovery, community verification.",
                    "Stage 4, Opportunities & Growth (2027): planned. Jobs and professional listings, skills and learning resources, mutual aid network, creator/business directory, educational content hub.",
                    "Stage 5, Global & Social (2027 – 2028): planned. Community groups and discussions, cross-border resource discovery, community-contributed multilingual content, iOS and Android apps, an open API.",
                ],
            },
        ],
    },
